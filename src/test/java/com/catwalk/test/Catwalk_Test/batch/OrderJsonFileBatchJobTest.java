...
import com.catwalk.test.Catwalk_Test.config.BatchDataSourceConfig;
import com.catwalk.test.Catwalk_Test.config.BatchRepositoryConfig;
...
class OrderJsonFileBatchJobTest {

  OrderJsonFileBatchJob batchJob;
  ...
  void before()  throws IOException {
    ...
    batchJob = new OrderJsonFileBatchJob( repository,  stepBuilderFactory,  jobLauncher,  jobBuilderFactory);
  }
