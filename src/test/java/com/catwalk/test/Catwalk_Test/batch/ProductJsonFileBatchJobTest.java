...
class ProductJsonFileBatchJobTest {

  ProductJsonFileBatchJob batchJob;
  ...
  void before()  throws IOException {
    ...
    batchJob = new ProductJsonFileBatchJob( repository,  stepBuilderFactory,  jobLauncher,  jobBuilderFactory);
  }
