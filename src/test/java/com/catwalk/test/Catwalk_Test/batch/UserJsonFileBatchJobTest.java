...
class UserJsonFileBatchJobTest {

  UserJsonFileBatchJob batchJob;
  ...
  void before()  throws IOException {
    ...
    batchJob = new UserJsonFileBatchJob( repository,  stepBuilderFactory,  jobLauncher,  jobBuilderFactory);
  }
