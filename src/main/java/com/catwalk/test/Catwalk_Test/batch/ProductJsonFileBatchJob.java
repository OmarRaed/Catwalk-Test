...
@Slf4j
@Component
public class ProductJsonFileBatchJob implements FileBatchJob<Map<String, Object>, Product> {
    ...
    public ProductJsonFileBatchJob(ProductRepo repository, StepBuilderFactory stepBuilderFactory, JobLauncher jobLauncher, JobBuilderFactory jobBuilderFactory) {
    ...
    */
    ...
    public void run(String stepName,Resource resource, int chunkSize) throws JobParametersInvalidException, JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException {
        ...
        Job job = jobBuilderFactory
                ...
                .flow(stepBuilderFactory
                        .get("step-" + stepName)
                        .<Map<String, Object>,Product>chunk(chunkSize)
    ...
    @Override
    public ItemProcessor<Map<String, Object>, Product> processor() {
        return map -> mapper.convertValue(map,Product.class);
    }
