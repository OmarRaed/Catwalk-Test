...
@Slf4j
@Component
public class OrderJsonFileBatchJob implements FileBatchJob<Map<String, Object>, Order> {
    ...
    public OrderJsonFileBatchJob(OrderRepo repository, StepBuilderFactory stepBuilderFactory, JobLauncher jobLauncher, JobBuilderFactory jobBuilderFactory) {
    ...
    */
    ...
    public void run(String stepName,Resource resource, int chunkSize) throws JobParametersInvalidException, JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException {
        ...
        Job job = jobBuilderFactory
                ...
                .flow(stepBuilderFactory
                        .get("step-" + stepName)
                        .<Map<String, Object>,Order>chunk(chunkSize)
    ...
    @Override
    public ItemProcessor<Map<String, Object>, Order> processor() {
        return map -> mapper.convertValue(map,Order.class);
    }
